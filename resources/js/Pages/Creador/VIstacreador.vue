            ...
            <div class="flex-1 overflow-y-auto">
                <div class="max-w-7xl mx-auto px-4 py-6">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                        ...
                        <!-- COLUMNA IZQUIERDA: Fachada, Logo, Nombre, Contacto y Redes (order-1 de primero en móvil y a la izq en desktop) -->
                        ...
                        <!-- COLUMNA DERECHA: Ubicación/Mapa, Promociones y Catálogo (En desktop a la der, en móvil va de segundo) -->
